...
amazonia_ts <- ts(amazonia$Queimadas, start=c(1998, 6), end=c(2019, 8), frequency = 12)
...
## Definir a variável como TS
amazon_trend_ts <- ts(dess_data_amazonia$trend,  start=c(1998, 6), end=c(2019, 8), frequency = 12)
